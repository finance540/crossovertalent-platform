-- Crossover Talent production schema
...
-- 2. Normalized production-equivalent tables for app operations.
-- 3. RLS policies.
...
comment on table public.app_records is
  'Production key-value record store used by Crossover Talent serverless APIs. Access is service-role only; no browser/client direct reads.';
...
-- Server-side APIs use the service role. Browser clients should not directly access these production tables yet.
do $$
declare
  t text;
begin
...
values
  ('crossover-cvs-production', 'crossover-cvs-production', false, 5242880, array[
    'application/pdf',
    'application/msword',
    'application/vnd.openxmlformats-officedocument.wordprocessingml.document',
    'text/plain'
  ]),
  ('crossover-job-descriptions-production', 'crossover-job-descriptions-production', false, 5242880, array[
    'application/pdf',
    'application/msword',
    'application/vnd.openxmlformats-officedocument.wordprocessingml.document',
    'text/plain'
  ]),
  ('crossover-company-logos-production', 'crossover-company-logos-production', true, 2097152, array[
    'image/png',
    'image/jpeg',
    'image/webp'
  ])
